...
public class BilletautomatGUI  extends javax.swing.JFrame 
{
    ...
    private ArrayList<Transaktioner> transaktioner = new ArrayList<Transaktioner>();
    ...
    private void købBilletActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_købBilletActionPerformed
    ...
    private void antalGUIActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_antalGUIActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_antalGUIActionPerformed
 
    private void ønsketBetalingActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_ønsketBetalingActionPerformed
        // TODO add your handling code here:
    ...
    private void BetalActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_BetalActionPerformed
     if (betalt != sum)
     {
      String betalt1;
        ...
        Transaktioner trans = new Transaktioner(new Date(),"Indbetaling:", betalt, betalt2);
    ...
    {
        for (Transaktioner trans : transaktioner)
        {
            System.out.println(trans.tid + " " + trans.beskrivelse + " mængde:" + trans.money + " nuværende balance: " + trans.currentBalance );
        }
            //patrick
       }
    
    private void udskrivbilletActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_udskrivbilletActionPerformed
        if (sum == betalt)
        {
...
// JOptionPane.showMessageDialog(null, "Du får " +tilbageBetaling+ "kr tilbage" ); 
    ...
    private void udskrivBillet() 
    {
        ...
        System.out.println("##########B##T#########");
        System.out.println();
        Transaktioner trans = new Transaktioner(new Date(), "Udskriving af billet");
                transaktioner.add(trans);
        }
        
         Transaktioner trans = new Transaktioner(new Date(), "Kunden fik " + tilbageBetaling + "kr retur");
         transaktioner.add(trans);
